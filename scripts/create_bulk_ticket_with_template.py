...
@click.command()
@click.option('--incidentid', default=15271,  help='ID of incident.')
@click.option('--tplname', prompt='Address of the template', help='Name of the template')
@click.option('--csv', prompt='CSV file of IPs', help='List of IPs')
def main(incidentid, tplname, csv):
    #if len(sys.argv) < 4:
